...
class BookingListCreateView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Check if the current_capacity exceeds the max_capacity (28) for the given section
        existing_capacity = Booking.objects.filter(date=date, time_slot=time_slot, section=section).aggregate(Sum('num_of_people'))['num_of_people__sum']
